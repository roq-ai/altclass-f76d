...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`Altclass`}</title>

        <meta
          name="description"
          content="Welcome to Altclass - Streamlining Tutor Management, Bridging the Gap between Tutors, Students, and Parents for Enhanced Learning Experiences."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1580894732930-0babd100d356?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx0dXRvcnxlbnwwfHx8fDE2OTAyNjc1OTZ8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Altclass - Streamlining Tutor Management, Bridging the Gap between Tutors, Students, and Parents for Enhanced Learning Experiences.`}
            </Text>
            <Box
